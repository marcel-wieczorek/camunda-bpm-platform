 ...
 * database using the DbSqlSession.
 * </p>
 * 
 * <p>
 * This history implementation is INSERT-only: when writing history events to
...
public class DbHistoryEventHandler implements HistoryEventHandler {
  ...
  public void handleEvent(HistoryEvent historyEvent) {
    ...
    final DbSqlSession dbSqlSession = Context.getCommandContext().getDbSqlSession();
